...
public class InputData {
    ...
    public InputData witchWiborPercent(BigDecimal wiborPercent){
        this.wiborPercent = wiborPercent;
        return this;
    }

    public InputData witchAmount(BigDecimal amount){
        this.amount = amount;
        return this;
    }
    public InputData witchMonthsDuration(BigDecimal monthsDuration){
        this.monthsDuration = monthsDuration;
        return this;
    }

    public InputData witchRateType(RateType rateType){
        this.rateType = rateType;
        return this;
    }

    public InputData witchBankMarginPercent(BigDecimal bankMarginPercent){
